  ...
  return (
    <main id="main-content" className="flex min-h-screen flex-col items-center justify-center p-4">
      <div className="w-full max-w-md text-center">
        ...
        <p className="mb-6 text-slate-600">Diese Seite existiert nicht oder wurde verschoben.</p>
        <Link
          href="/"
          className="bg-navy-900 hover:bg-navy-800 inline-block rounded-md px-4 py-2 text-white"
        >
          Zur Startseite
        </Link>
      </div>
