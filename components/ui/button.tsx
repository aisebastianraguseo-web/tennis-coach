...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  secondary:
    'border border-navy-900 text-navy-900 hover:bg-slate-50 disabled:border-slate-300 disabled:text-slate-400',
  ...
  return (
    <button
      ...
      className={cn(
        ...
        'focus-visible:outline-navy-900 focus-visible:outline-2 focus-visible:outline-offset-2',
